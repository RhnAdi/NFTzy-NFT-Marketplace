export default function TopCreator(){
   ...
   return(
      <div id="top_creator" className="text-gray-100 my-10">
         <p className="text-lg lg:text-2xl font-bold tracking-wider mb-4">Most Creator</p>
         <div className="flex flex-col md:flex-row gap-x-5">
            <div className="w-full">
               {
                  creator1.map((creator, index) => {
                     return(
                        <div key={index} className="flex items-center border-b border-gray-800 justify-between px-4 py-4 gap-x-6 hover:border hover:shadow hover:shadow-gray-700/70 hover:rounded-md">
            ...
            <div className="w-full">
               {
                  creator2.map((creator, index) => {
                     return(
                        <div key={index + 1 + slicer} className="flex items-center border-b border-gray-800 justify-between px-4 py-4 gap-x-6 hover:border hover:shadow hover:shadow-gray-700/70 hover:rounded-md">
