   ...
   return(
      <div className="text-gray-100 my-10 flex flex-col gap-y-10">
         <div className="flex flex-col justify-center items-center gap-y-3">
            <p className="text-lg lg:text-2xl font-bold tracking-wider text-gray-900 dark:text-white">Subscribe</p>
            <input placeholder="Email Address ..." className="md:w-96 w-72 px-3 py-2 bg-gray-200 dark:bg-gray-800 rounded-lg outline-none" />
            <button className="bg-red-700 px-5 py-2 rounded-lg">Subscribe</button>
         </div>
         <div className="flex flex-col justify-center items-center gap-y-3">
            <p className="text-lg lg:text-2xl font-bold tracking-wider text-gray-900 dark:text-white">Community</p>
